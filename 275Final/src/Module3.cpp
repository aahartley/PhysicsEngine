...
void Application::setup() {
	running = Graphics::openWindow("Austin Hartley Assignment3");//openWindow();
	...
	Particle* light = new Particle(5, 25, 1, 2);
...
void Application::update() {
	...
	for (auto particle : particles) {
		...
		if (particle->velocity.magnitude() > 0.01) particle->addForce(drag);
	}
